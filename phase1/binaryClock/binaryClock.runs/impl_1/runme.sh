...
HD_PWD='/home/drew/vhdl-dsp-project/DSP-VHDL-Arty-S7/phase1/binaryClock/binaryClock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log binary_Clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source binary_Clock.tcl -notrace
