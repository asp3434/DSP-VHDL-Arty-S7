...
HD_PWD='/home/drew/vhdl-dsp-project/DSP-VHDL-Arty-S7/phase1/binaryClock/binaryClock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binary_Clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binary_Clock.tcl
